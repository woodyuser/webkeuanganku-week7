...
export const TransactionList = () => {
  ...
  const SpreadsheetButton = useMemo(() => (
    <button
      onClick={() => window.open('https://docs.google.com/spreadsheetshttps://docs.google.com/spreadsheets/d/13R7DMR-AuSLD3OwLqitII78zFsuaGHxXB_huRegFHdk/edit?gid=0#gid=0', '_blank')}

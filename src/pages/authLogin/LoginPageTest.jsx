...
describe('LoginPage', () => {
  it('renders the login page correctly', () => {
    ...
    expect(screen.getByPlaceholderText('Nomor Handphone')).toBeInTheDocument();
...
describe('LoginForm', () => {
  it('handles form input and submission correctly', () => {
    ...
    const nomorHandphoneInput = screen.getByPlaceholderText('Nomor Handphone');
    const submitButton = screen.getByText('SIGN IN');

    // Fill in the form
    fireEvent.change(emailInput, { target: { value: 'test@example.com' } });
    fireEvent.change(passwordInput, { target: { value: 'password123' } });
    fireEvent.change(nomorHandphoneInput, { target: { value: '08123456789' } });

...
import { useNavigate } from 'react-router-dom'; // pakai react-router-dom
...
export const SummaryCard = ({
  ...
  return (
    <div 
      className={`flex flex-col p-5 mt-5 w-full ${backgroundColor} rounded-md ${textColor} cursor-pointer`}
      onClick={handleClick}
    >
      ...
      <div className="flex gap-1.5 justify-center items-start self-end mt-5 text-sm leading-none">
        <div className="font-poppins underline">Lihat Detail</div>
        <img
